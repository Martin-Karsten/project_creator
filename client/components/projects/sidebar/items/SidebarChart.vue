<template>
    <el-row class="sidebar-chart">
        <el-row>
            <el-col>
                <el-input :value="currentItem.chart_settings.title.text" @input="updateTitle" placeholder="Chart Title"></el-input>
            </el-col>
            <el-col>
            ...
            <el-col :span="2">
                <el-checkbox :checked="currentItem.chart_settings.legend.show" @input="showLegend" />
            </el-col>
            ...
            <el-row class="y-axis-title">
                <el-col :span="4">
                    <h3 class="sidebar-axis-title">Y-Axis</h3>
                </el-col>
                <el-col :span="16">
                    <el-input placeholder="Title" @input="updateYAxisTitle"></el-input>
                </el-col>
                <el-col :span="4">
                    <el-input type="number" :value="currentItem.chart_settings.yAxis.nameTextStyle.fontSize" min="0" max="30" @input="updateYAxisTitleSize"></el-input>
                </el-col>

                <el-col :span="4">
                    <h3 class="sidebar-axis-title">X-Axis</h3>
                </el-col>
                <el-col :span="16">
                    <el-input placeholder="Title" @input="updateXAxisTitle"></el-input>
                </el-col>
                <el-col :span="4">
                    <el-input type="number" :value="currentItem.chart_settings.xAxis.nameTextStyle.fontSize" min="0" max="30" @input="updateXAxisTitleSize"></el-input>
                </el-col>
            </el-row>

        <el-collapse class="coordinates-collapse">
            <el-collapse-item title="Coordinates">
                <el-row v-for="(series, index) in currentItem.chart_settings.series" :key="index">
                    <el-col :span="1">
                        <strong>{{series.name}}</strong>
                    </el-col>
                    <el-col :span="16">
                        <el-input :value="currentItem.chart_settings.series[index].name" size="small" @input="updateSeriesName" placeholder="Name"></el-input>
                    </el-col>
                    <el-col :span="7">
                        <el-color-picker :value="currentItem.chart_settings.series[index].itemStyle.color" @input="updateSeriesColor(index, $event)" size="small"></el-color-picker>
                    ...
                    <el-col>
                        <el-collapse>
                            <el-collapse-item title="Y-Axis">
                                <el-row>
                                    <el-col v-for="(yItem, yIndex) in currentItem.chart_settings.series[0].data" :key="yIndex" :span="4">
                                        <el-input size="small" :value="currentItem.chart_settings.series[0].data[yIndex]" @input="updateYAxisValue(yIndex, $event)"/>
                                    </el-col>
                                </el-row>
                            </el-collapse-item>
                            ...
                            <el-collapse-item title="X-Axis">
                                <el-row>
                                    <el-col v-for="(xItem, xIndex) in currentItem.chart_settings.xAxis.data" :key="xIndex" :span="4">
                                        <el-input size="small" :value="currentItem.chart_settings.xAxis.data[xIndex]" @input="updateXAxisValue(xIndex, $event)"/>
                                    </el-col>
                                </el-row>
                            </el-collapse-item>
                        </el-collapse>
                    ...
                    <el-col>
                        <el-button size="mini" class="el-icon-plus" @click="addSeries"></el-button>
                    </el-col>
            </el-collapse-item>
        </el-collapse>
    </el-row>
