    ...
    <el-collapse class="border-collapse">
      <el-collapse-item title="Border" class="border-collapse">
        <el-col class="sidebar-format-column" :span="21">
          <h3 class="sidebar-format-title">
            No Border
          </h3>
        </el-col>
        <el-col class="sidebar-format-column" :span="1">
          <el-checkbox
            :checked="currentItem.border_width === 0"
            @input="activateBorder"
          />
        </el-col>
        ...
        <el-col class="sidebar-format-column" :span="1">
          <el-color-picker
            :value="currentItem.border_color"
        ...
        <el-col class="sidebar-format-column" :span="10">
          <el-input-number
            :value="currentItem.border_width"
            :min="0"
            :max="30"
        ...
        <el-col class="sidebar-format-column" :span="13">
          <el-select
            :value="currentItem.border_style"
            placeholder="Select"
        ...
        <el-col class="sidebar-format-column" :span="10">
          <el-input-number
            :value="currentItem.border_radius"
            :min="0"
            :max="30"
...
export default {
  ...
  methods: {
    activateBorder() {
      let width = 0
      if (this.currentItem.border_width === 0) width = 1
      else width = 0
