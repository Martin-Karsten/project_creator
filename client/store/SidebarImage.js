...
ADD_COMPONENT (state, payload) {
    if(payload == 0){
      state.sidebarImage[0] = {id: payload, name: 'sidebarImage', fontSize: 12, fontColor: 'black'}
    }
    else
    state.sidebarImage.push({id: payload, name: 'sidebarImage', fontSize: 12, fontColor: 'black'})
  },
