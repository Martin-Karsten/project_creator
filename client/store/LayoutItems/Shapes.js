...
export const mutations = {
    ...
    ADD_RECTANGLE(state, payload) {
        ...
        let obj = {[payload.layoutId]:{id: id, project_id: state.projectId, name: 'rectangle', shape_name: 'rectangle-shape', itemName: 'shapes',
        background_color: 'none', border_color: 'black', border_style: 'solid', animations: {},
        border_width: 1, border_radius: 0, opacity: 1.00,
        top:1, left:0, width:200, height:100}}
    ...
    ADD_CIRCLE(state, payload) {
        ...
        let obj = {[payload.layoutId]:{id: id, project_id: state.projectId, name: 'circle', shape_name: 'circle-shape', itemName: 'shapes',
        background_color: 'none', border_color: 'black', border_style: 'solid', animations: {},
        border_width: 1, border_radius: 0, opacity: 1.00,
        top:1, left:0, width:200, height:100}}
    ...
    ADD_TRIANGLE(state, payload) {
        ...
        let obj = {[payload.layoutId]:{id: id, project_id: state.projectId, name: 'triangle', shape_name: 'triangle-shape', itemName: 'shapes',
        background_color: 'none', border_color: 'black', border_style: 'solid', animations: {},
        border_width: 1, border_radius: 0, opacity: 1.00,
        top:1, left:0, width:200, height:100}}
    ...
    ADD_LINE(state, payload) {
        ...
        let obj = {[payload.layoutId]:{id: id, project_id: state.projectId, name: 'line', shape_name: 'line-shape', itemName: 'shapes',
        background_color: 'none', border_color: 'black', border_style: 'solid', animations: {},
        border_width: 1, border_radius: 0, opacity: 1.00,
        top:1, left:0, width:150, height:2}}
...
export const actions = {
    ...
    addShape({state, commit}, payload) {
        ...
        commit('Layout/ADD_SHAPE', {layoutId: payload.layoutId, id: id}, {root: true})
    }
}
