...
export const mutations = {
    ...
    ADD_TEXTFIELD(state, payload) {
        ...
        let id = length + 1
        let obj = {[payload]:{id: id, project_id: state.projectId, name: 'textfield', itemName: 'textfields', text:'333333333333',
...
export const actions = {
    ...
    addTextfield({state, commit}, payload){
        ...
        commit('Layout/ADD_TEXTFIELD', {layoutId: payload, id: id}, {root: true})
    },
}
